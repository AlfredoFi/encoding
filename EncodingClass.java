public class EncodingClass {
  ...
  private final static int mask = 0xFF;  //mascara utilizada para el encodig

  public static void printByteArray(byte[] val){  //función para imprimir por byte todo el arreglo
    StringBuilder str = new StringBuilder(); //Decllaración de objeto str tipo Stringbuilder
    for(byte b : val){   //aplica la mascara a cada byte
